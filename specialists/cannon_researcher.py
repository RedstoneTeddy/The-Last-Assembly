...
class Cannon_researcher(base.Base_specialist):
    def __init__(self, data : data_class.Data_class) -> None:
        super().__init__(data)

        self.internal_name : data_class.SpecialistNames = "cannon_researcher"
        ...
        self.description : list[data_class.TextLine] = [
            ...
            data_class.TextLine(text="Cannons", color=(0,0,150), icon="", is_small=False),
