...
class Tower_deal_hunter(base.Base_specialist):
    def __init__(self, data : data_class.Data_class) -> None:
        super().__init__(data)

        self.internal_name : data_class.SpecialistNames = "tower_deal_hunter"
        self.name : str = "Deal Hunter"

        self.description : list[data_class.TextLine] = [
            data_class.TextLine(text="Tower boxes", color=(0,0,0), icon="", is_small=False),
