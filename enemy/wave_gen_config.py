...
class WaveGenConfig:
    ...
    num_groups_increase : float = 1.03
    groups_random_factor : float = 0.2
    group_time_budget_random_factor : float = 0.3 # Random factor for the time and budget assigned to each group (e.g. 0.2 means +/- 20% randomization)
    
    #### - Enemy parameters - ####
    # The cost of each enemy type, used for balancing the waves.
    enemy_cost : dict[tuple[int, data_class.SpecialEnemyTypes], int] = {
        (1, "") : 1,
        (2, "") : 2,
        (3, "") : 3,
        (4, "") : 4,
    ...
    enemy_first_wave : dict[tuple[int, data_class.SpecialEnemyTypes], int] = {
        (1, "") : 1,
        (2, "") : 3,
        (3, "") : 5,
        (4, "") : 6,
